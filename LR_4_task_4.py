...
visualize_classifier(classifier, X, y) # РИСУНОК 5 ЗВІТУ
...
visualize_classifier(classifier_new, X_test, y_test) # РИСУНОК для другого прогону

# --- Оцінка за допомогою перехресної перевірки ---
num_folds = 3
